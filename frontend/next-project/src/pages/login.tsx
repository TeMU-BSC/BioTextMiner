    ...
    <div>
      ...
      <div>
        <form
          ...
          className="w-80 flex flex-col space-y-4 mx-auto"
        >
          <label className="text-center m-6 text-sky-400/100 text-3xl font-extrabold underline">
            Login
          </label>
          <div>
          ...
          <button
            type="submit"
            className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded animate-pulse"
          >
            Login
          </button>
